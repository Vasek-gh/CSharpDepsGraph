...
internal class SymbolVisitor : Microsoft.CodeAnalysis.SymbolVisitor
{
    ...
    {
        if (
            symbol.Name == "AutoGeneratedProgram"
            || symbol.Name == "Car"
            || symbol.Name == "Complex"
            || symbol.Name == "NewerUser"
            || symbol.Name == "NewUser"
            || symbol.Name == "User"
            || symbol.Name == "UserWithPic"
            || symbol.Name == "UInt32ValueReflection"
            || symbol.Name == "TimestampValueReflection"
            || symbol.Name == "TimestampValue"
            || (symbol.Name == "UInt32Value" && symbol.ContainingNamespace.IsGlobalNamespace)
        )
        {
            return; // todo
        }
