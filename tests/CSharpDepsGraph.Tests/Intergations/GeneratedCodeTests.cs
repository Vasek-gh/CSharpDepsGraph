...
public class GeneratedCodeTests : BaseIntergationsTests
{
    ...
    public void AssemblyInfoIgnored()
    {
        ...
        var graph2 = GetGraph(o => o.ParseVisibleGeneratedCode = true);
    ...
    {
        var graph1 = GetGraph();
        var node1 = graph1.GetNode("TestProject.Cli", "TestProject/Cli/GenComment");
    ...
    {
        var graph1 = GetGraph();
        var node1 = graph1.GetNode("TestProject.Cli", "TestProject/Generated/Foo");
        var methodNode1 = node1.GetNode("PublicMethod()");
